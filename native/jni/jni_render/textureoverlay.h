...
#ifndef VIRTUALBEAUTY_TEXTUREOVERLAY_H
#define VIRTUALBEAUTY_TEXTUREOVERLAY_H

#include "basetexture.h"

namespace render {

    class TextureOverlay : public BaseTexture {
    ...
    public:
        ...
        void setBaseTextureId(GLuint BaseTexture);

        void setBlendTextureId(GLuint lendTexture);
...
#endif //VIRTUALBEAUTY_TEXTUREOVERLAY_H
