...
#ifndef VIRTUALBEAUTY_SKINCOLOR_H
#define VIRTUALBEAUTY_SKINCOLOR_H

#include "basetexture.h"

namespace render {

    class SkinColor : public BaseTexture {
    ...
    public:
        ...
        void setCameraTextureId(GLuint Lip_Texture);
...
#endif //VIRTUALBEAUTY_SKINCOLOR_H
