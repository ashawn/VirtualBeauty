...
#ifndef VIRTUALBEAUTY_BILATERALFILTER_H
#define VIRTUALBEAUTY_BILATERALFILTER_H

#include "basetexture.h"

namespace render {

    class BilateralFilter : public BaseTexture {
    ...
    private:
        ...
        GLint m_Width_Handle;
        GLint m_Height_Handle;
        GLint m_Factor_Handle;
...
#endif //VIRTUALBEAUTY_BILATERALFILTER_H
