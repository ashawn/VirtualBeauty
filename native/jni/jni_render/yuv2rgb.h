...
#ifndef VIRTUALBEAUTY_YUV2RGB_H
#define VIRTUALBEAUTY_YUV2RGB_H

#include "basetexture.h"

namespace render {

    class YUV2RGB : public BaseTexture {
    ...
    public:
        ...
        void setYUV(GLbyte* YData,GLbyte* UData,GLbyte* VData,int width, int height);
