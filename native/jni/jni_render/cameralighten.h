...
#ifndef VIRTUALBEAUTY_CAMERALIGHTEN_H
#define VIRTUALBEAUTY_CAMERALIGHTEN_H

#include "basetexture.h"

namespace render {

    class CameraLighten : public BaseTexture {
    ...
    public:
        ...
        void setCameraTextureId(GLuint CameraTexture);
...
#endif //VIRTUALBEAUTY_CAMERALIGHTEN_H
