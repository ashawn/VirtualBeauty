...
#ifndef VIRTUALBEAUTY_TEXTUREMULTIPLYCOLOR_H
#define VIRTUALBEAUTY_TEXTUREMULTIPLYCOLOR_H

#include "basetexture.h"

namespace render {

    class TextureMultiplyColor : public BaseTexture {
...
#endif //VIRTUALBEAUTY_TEXTUREMULTIPLYCOLOR_H
