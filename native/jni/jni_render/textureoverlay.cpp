...
void TextureOverlay::init() {
    ...
    m_Program = glutil::get_program_by_type(TEXTURE_OVERLAY);
...
GLuint TextureOverlay::getFrameTextureId() {
    return mFrameTexture;
}

void TextureOverlay::setBaseTextureId(GLuint BaseTexture) {
    mBaseTexture = BaseTexture;
}

void TextureOverlay::setBlendTextureId(GLuint BlendTexture) {
    mBlendTexture = BlendTexture;
}

void TextureOverlay::draw() {
    LOG(INFO) << "TextureOverlay draw";
...
void TextureOverlay::loadShader(GLuint program) {
    m_Program = program;
}

void TextureOverlay::update(int width, int height) {
    mWidth = width;
    mHeight = height;
    glBindFramebuffer(GL_FRAMEBUFFER,m_Frame_GL_Buffer);
